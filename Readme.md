...
- **Brute Force Koruması:** AccessFailedCount ve LockoutEnd parametreleri ile 3 hatalı deneme sonrası şifre sıfırlamaya yönlendirir.
...
| **Admin Ana Sayfa** | Sistem istatistikleri ve kilitli hesapların yönetimi.      |
