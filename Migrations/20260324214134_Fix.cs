    ...
    public partial class Fix : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Comments_Rentals_RentId",
                        column: x => x.RentId,
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Date", "Name", "Surname", "UserRole" },
                values: new object[] { 1, new DateTime(2024, 6, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "deneme", "deneme", 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "deneme@deneme.com", "deneme123", 1 });
